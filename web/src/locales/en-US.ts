...
export default {
  ...
  knowledge: {
    ...
    ragGuideTitle: 'To enable knowledge base, follow these steps:',
    ragGuideStep1: 'Set xiaozhi.rag.enabled=true in application.yml',
    ragGuideStep2: 'Add an embedding model configuration in the admin console',
    ragGuideStep3: 'Ensure Redis is running (used for vector storage)',
    pollingTimeout: 'Processing timed out. Please refresh the page later to check status.',
    embeddingModel: 'Embedding Model',
    embeddingModelPlaceholder: 'Select embedding model',
    noEmbeddingModel: 'No embedding models available',
    noEmbeddingModelTip: 'Please add an embedding model in the configuration management first',
    embeddingModelChangeWarning: 'Changing the model requires reprocessing existing documents to take effect',
  ...
  mqtt: {
    ...
    notEnabled: 'MQTT Not Enabled',
    enableHint: 'Set xiaozhi.mqtt.enabled: true in application-dev.yml and configure broker URL to enable MQTT',
    setupGuideTitle: 'MQTT is not enabled. Follow these steps to configure:',
    setupStep1: 'Deploy an MQTT Broker (e.g. Eclipse Mosquitto):',
    setupStep2: 'Edit application-dev.yml, set xiaozhi.mqtt.enabled: true and broker-url: tcp://localhost:1883',
    setupStep3: 'Restart the backend service',
    connectFailTitle: 'MQTT Broker connection failed. Please check:',
    connectFailCheck1: 'Is the MQTT Broker service running?',
    connectFailCheck2: 'Is the broker-url configuration correct?',
    connectFailCheck3: 'If the Broker requires authentication, check username/password settings',
    brokerUrl: 'Broker URL',
    topicPrefix: 'Topic Prefix',
    clientId: 'Client ID',
    keepAliveInterval: 'Keep Alive Interval',
    operations: 'Operations',
    wakeupDevice: 'Wakeup Device',
    sendNotification: 'Send Notification',
    broadcastMessage: 'Broadcast Message',
    wakeup: 'Wakeup',
    notify: 'Notify',
    broadcast: 'Broadcast',
    wakeupMessage: 'Wakeup message (optional)',
    pleaseEnterDeviceId: 'Please enter device ID',
    pleaseEnterText: 'Please enter text',
    pleaseEnterBroadcastText: 'Please enter broadcast text',
    wakeupSuccess: 'Wakeup command sent',
    ...
    broadcastConfirmTitle: 'Confirm Broadcast',
    broadcastConfirmContent: 'Are you sure you want to broadcast this message to all devices?',
    refreshSuccess: 'Refreshed',
    deviceStatusList: 'Device Status List',
    deviceId: 'Device ID',
    deviceName: 'Device Name',
    state: 'State',
    channels: 'Channels',
    ...
    sensorHistoryTitle: 'Sensor History',
    loadSensorFailed: 'Failed to load sensor data',
    // OTA Push
    otaPush: 'OTA Push',
    otaDeviceHint: 'Device ID (empty=broadcast all)',
    otaVersion: 'Firmware version',
    otaUrl: 'Firmware download URL',
    otaPushBtn: 'Push OTA',
    otaPushSuccess: 'OTA notification sent',
    otaPushFailed: 'OTA push failed',
    otaFormRequired: 'Please fill in version and URL',
    // Remote Config
    remoteConfig: 'Config',
    remoteConfigTitle: 'Remote Configuration',
    configVolume: 'Volume (0-100)',
    configWakeWord: 'Wake Word',
    configWakeWordHint: 'e.g. Hi Xiaozhi',
    configLedBrightness: 'LED Brightness (0-100)',
    configTimezone: 'Timezone',
    configLanguage: 'Language',
    configEmpty: 'Please fill in at least one config item',
    configPushSuccess: 'Config pushed',
    ...
    deleteGroupConfirm: 'Confirm delete group?',
    members: 'Members',
    ...
    logMessage: 'Message',
    logResult: 'Result',
    noSendLog: 'No send records',
    // AEC
    aecTitle: 'AEC Echo Cancellation',
    aecEnabled: 'Status',
    aecStreamDelay: 'Initial Delay',
    aecNoiseLevel: 'Noise Suppression',
  },
}
